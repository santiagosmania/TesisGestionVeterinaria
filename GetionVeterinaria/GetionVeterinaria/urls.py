...
urlpatterns = [
    ...
    path('obtener_pacientes/', app.views.obtener_pacientes, name='obtener_pacientes'),
    path('obtener_pacientes/', app.views.obtener_pacientes2, name='obtener_pacientes2'),
    path('crear-historialclinico/<int:idpaciente>/', app.views.Crear_Historial_Clinico, name='crear_historialclinico'),
    path('obtener_especies_por_raza/', app.views.obtener_especies_por_raza, name='obtener_especies_por_raza'),
    ...
    path('chat/', app.views.chat, name="chat_bot"),
    ...
    path('verificar-hora-ocupada/', app.views.verificar_hora_ocupada, name='verificar_hora_ocupada'),
